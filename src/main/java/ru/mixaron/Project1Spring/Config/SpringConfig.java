package ru.mixaron.Project1Spring.Config;
...
@Configuration
@ComponentScan("ru.mixaron.Project1Spring")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableJpaRepositories("ru.mixaron.Project1Spring.repositories")
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.mixaron.Project1Spring.PersonAndBooks");
